...
#include <APPLICATIONS/session/server/VoIP.hpp>

using namespace applications::session::server;

STATIC_FACTORY_REGISTER_WITH_CREATOR(applications::session::server::VoIP,
				     applications::session::Session,
				     "server.VoIP", wns::PyConfigViewCreator);
