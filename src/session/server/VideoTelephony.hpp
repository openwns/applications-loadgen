...
#define APPLICATIONS_SESSION_SERVER_VIDEOTELEPHONY_HPP
...
namespace applications { namespace session { namespace server {
	...
	applications::session::server::VideoTelephonyState voiceState;
...
#endif //APPLICATIONS_SESSION_SERVER_VIDEOTELEPHONY_HPP
